...
app.post('/api/insumos', async (req, res) => {
    try {
        ...
        res.status(400).json({ success: false, message: 'Erro ao salvar insumo.' });
    }
});
...
app.put('/api/insumos/:id/repor', async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: 'Erro ao repor estoque.' });
    }
});
...
app.post('/api/solicitacoes', async (req, res) => {
    try {
        ...
        res.status(400).json({ success: false, message: 'Erro ao criar solicitação.' });
    }
});
...
app.get('/api/unidades/estoques', async (req, res) => {
    try {
        ...
        res.status(500).json({success: false, message: 'Erro ao buscar estoques.'});
    }
});
